...
Structured representation of a user's food-ordering intent extracted from
...
class FoodOrderIntent(BaseModel):
    ...
    def _enforce_clarification_invariants(self) -> "FoodOrderIntent":
        ...
        # A request with no items, no restaurant, and no meal type is completely un-actionable
