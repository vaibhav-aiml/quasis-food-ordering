...
Before ``InstamartAppiumAdapter`` can automate anything real:

1. Install the real Instamart app on your device/emulator.
...
Until step 4 is done, ``InstamartAppiumAdapter.search()`` will fail with
...
LOCATORS = StoreLocatorConfig(
    app_package="CHANGE_ME_instamart_app_package",
    app_activity="CHANGE_ME_instamart_main_activity",
    search=SearchScreenLocators(
        search_box=("id", "CHANGE_ME_instamart_search_box_id"),
        search_submit_button=None,  # assumed auto-search-as-you-type; verify
    ),
    product_card=ProductCardLocators(
        product_card=("id", "CHANGE_ME_instamart_product_card_id"),
        title=("id", "CHANGE_ME_instamart_product_title_id"),
        price=("id", "CHANGE_ME_instamart_product_price_id"),
        eta=None,  # verify whether Instamart shows per-card ETA or one global ETA
        quantity=("id", "CHANGE_ME_instamart_product_quantity_id"),
        add_to_cart_button=("id", "CHANGE_ME_instamart_add_to_cart_button_id"),
    ),
    checkout=CheckoutLocators(
        cart_icon=("id", "CHANGE_ME_instamart_cart_icon_id"),
        proceed_to_checkout_button=("id", "CHANGE_ME_instamart_proceed_to_checkout_id"),
        payment_screen_indicator=("id", "CHANGE_ME_instamart_payment_screen_indicator_id"),
    ),
)
