...
from app.grocery.domain.intent import CLARIFICATION_CONFIDENCE_CEILING, IntentRequest
from app.grocery.domain.product import ProductRequest

_logger = logging.getLogger("app.grocery.agents.intent")
...
class _ExtractedPriority(str, Enum):
    ...
    Kept deliberately separate from ``app.shared.domain.constraints.Priority``
