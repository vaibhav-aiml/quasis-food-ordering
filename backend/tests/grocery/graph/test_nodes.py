...
app.grocery.graph.nodes.* — Phase 15 rewrite.
...
from app.grocery.graph.nodes.order_execution import _normalized_to_raw, make_order_execution_node
...
from app.grocery.graph.nodes.terminal import cancelled_node, failed_node, ready_for_payment_node
...
from app.grocery.processing.approval import ApprovalOutcome, ApprovalOutcomeStatus
...
def test_approval_approved_proceeds_to_order_execution(monkeypatch) -> None:
    import app.grocery.graph.nodes.approval as approval_module
