"""Tests for app.automation.waits.
...
from app.automation.exceptions import AutomationTimeoutError
from app.automation.waits import wait_for_element, wait_for_element_clickable
