...
``app.adapters.locators.CheckoutLocators`` has exactly three fields —
...
from app.adapters._appium_search import _dismiss_overlays
from app.adapters.locators import StoreLocatorConfig
from app.automation.gestures import tap, type_text
from app.automation.screenshots import capture_screenshot
from app.automation.waits import DEFAULT_TIMEOUT_SECONDS, wait_for_element
from app.adapters.types import CartActionResult, CheckoutState
from app.domain.raw_product_result import RawProductResult

_logger = logging.getLogger("app.adapters.appium_order")
