"""Real, Appium-backed Blinkit adapter — Phase 8 (search) + Phase 14
(cart/checkout).

Implements the SAME ``StoreAdapter`` protocol as ``BlinkitAdapter`` (Phase
...
_logger = logging.getLogger("app.adapters.blinkit.appium")


class BlinkitAppiumAdapter:
    """Real Appium-backed Blinkit integration.

    NOTE: ``app/adapters/blinkit/locators.py`` currently contains
    ...
    def _ensure_session(self) -> None:
        ...
        if not self._driver_manager.is_active:
