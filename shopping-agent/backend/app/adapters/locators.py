...
from app.automation.waits import Locator
...
class ProductCardLocators(BaseModel):
    ...
    add_to_cart_button: Locator | None = Field(
        ...
        description=(
            ...
            "app.adapters._appium_order.add_product_to_cart_via_appium "
            "to succeed."
        ),
    )
...
class StoreLocatorConfig(BaseModel):
    ...
    checkout: CheckoutLocators | None = Field(
        ...
        description=(
            ...
            "app.adapters._appium_order.checkout_via_appium to succeed."
        ),
    )
